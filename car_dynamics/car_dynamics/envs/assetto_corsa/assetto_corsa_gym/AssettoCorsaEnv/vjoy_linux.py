...
class vJoy:
    ...
    def update(self, joystickPosition):
        ...
        try:
            ...
            # Axis codes for xboxdrv's Xbox 360 device.
            ...
            # Button bit 0 maps to Xbox A, used by the Vjoy_linux preset as gear up.
            button_a = bool(values[19] & 0x00000001)
            if button_a != self.button_a_pressed:
                self._send_event(0x01, 0x130, 1 if button_a else 0)
